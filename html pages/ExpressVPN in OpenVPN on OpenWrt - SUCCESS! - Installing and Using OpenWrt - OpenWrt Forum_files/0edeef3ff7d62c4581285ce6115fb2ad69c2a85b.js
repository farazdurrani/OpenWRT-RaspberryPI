(function() {
  if ('require' in window) {
    require("discourse/lib/theme-settings-store").registerSettings(16, {"emoji_icon":"👩🏽‍💻","disable_at_trust_level":-1,"sensitivity":1.0,"min_post_length_to_check":25,"max_post_length_to_check":-1,"custom_regex_strings":"^#!|^root@|^config |^\\[ *\\d*\\.\\d*\\] ","include_extra_patterns":true,"include_html":true});
  }
})();
if ('define' in window) {
define("discourse/theme-16/unformatted-code-detector/core/strip-ignored-content", ["exports"], function (_exports) {
  "use strict";
  ...
  var settings = require("discourse/lib/theme-settings-store").getObjectForTheme(16);
...
if ('define' in window) {
define("discourse/theme-16/unformatted-code-detector/helpers/boundaries", ["exports"], function (_exports) {
  "use strict";
...
if ('define' in window) {
define("discourse/theme-16/unformatted-code-detector/helpers/emoji-diversity", ["exports"], function (_exports) {
  "use strict";
...
if ('define' in window) {
define("discourse/theme-16/unformatted-code-detector/core/code-energy", ["exports"], function (_exports) {
  "use strict";
  ...
  var _codeEnergyIndicators = (_codeEnergyIndicators2 = {}, _defineProperty(_codeEnergyIndicators2, CodeEnergyLevels.Complex, {
    get indicators() {
      return [nonHtmlIndicators, settings.include_extra_patterns && settings.custom_regex_strings.split("|"), settings.include_html && htmlIndicators].filter(Boolean).flat();
    }
...
if ('define' in window) {
define("discourse/theme-16/unformatted-code-detector/core/detect-code", ["exports", "../helpers/boundaries", "./strip-ignored-content", "./code-energy", "./sensitivity"], function (_exports, _boundaries, _stripIgnoredContent, _codeEnergy, _sensitivity) {
  "use strict";
...
if ('define' in window) {
define("discourse/theme-16/unformatted-code-detector/core/sensitivity", ["exports"], function (_exports) {
  "use strict";
...
(function() {
  if ('Ember' in window) {
    Ember.TEMPLATES["javascripts/modal/ucd-warning-modal"] = Ember.HTMLBars.template({"id":null,"block":"{\"symbols\":[],\"statements\":[[4,\"d-modal-body\",null,[[\"rawTitle\"],[[28,\"ucd-modal-title\",null,null]]],{\"statements\":[[0,\"  \"],[1,[28,\"cook-text\",[[28,\"theme-i18n\",[16,\"warning_modal.content\"],null]],null],false],[0,\"\\n  \"],[7,\"label\",true],[10,\"for\",\"ucd_do-not-show-again\"],[10,\"class\",\"checkbox-label\"],[8],[0,\"\\n    \"],[1,[28,\"input\",null,[[\"type\",\"id\",\"name\",\"checked\"],[\"checkbox\",\"ucd_do-not-show-again\",\"ucd_do-not-show-again\",[24,[\"model\",\"ucd_shouldPermanentlyDismiss\"]]]]],false],[0,\"\\n    \"],[1,[28,\"theme-i18n\",[16,\"warning_modal.do_not_show_again\"],null],false],[0,\"\\n  \"],[9],[0,\"\\n  \"],[7,\"div\",true],[10,\"class\",\"action-buttons\"],[8],[0,\"\\n    \"],[1,[28,\"d-button\",null,[[\"action\",\"icon\",\"tagName\",\"class\",\"label\"],[[28,\"action\",[[23,0,[]],\"goBackAndFix\"],null],\"pencil-alt\",\"button\",\"btn-primary\",[28,\"theme-prefix\",[16,\"warning_modal.fix_post\"],null]]]],false],[0,\"\\n    \"],[1,[28,\"d-button\",null,[[\"action\",\"tagName\",\"label\"],[[28,\"action\",[[23,0,[]],\"ignoreAndProceed\"],null],\"button\",[28,\"theme-prefix\",[16,\"warning_modal.ignore_and_post_anyway\"],null]]]],false],[0,\"\\n  \"],[9],[0,\"\\n\"]],\"parameters\":[]},null]],\"hasEval\":false}","meta":{}});
  }
})();

if ('define' in window) {
define("discourse/theme-16/unformatted-code-detector/initializers/init", ["exports", "discourse/lib/plugin-api", "discourse/lib/show-modal", "../core/detect-code", "../helpers/emoji-diversity", "discourse/lib/text", "@ember/template", "discourse-common/lib/helpers", "I18n", "pretty-text/sanitizer"], function (_exports, _pluginApi, _showModal, _detectCode, _emojiDiversity, _text, _template, _helpers, _I18n, _sanitizer) {
  "use strict";
